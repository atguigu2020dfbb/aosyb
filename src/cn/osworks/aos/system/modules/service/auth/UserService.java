...
public class UserService {
	 ...
	 */
	@Transactional
	public Dto updateUserButton(Dto inDto) {
		Dto outDto = Dtos.newDto();
		Aos_sys_userPO aos_sys_userPO = new Aos_sys_userPO();
		AOSUtils.copyProperties(inDto, aos_sys_userPO);
		// 更新用户基本信息
	 ...
	 * @return
	 */
    public boolean updateUser_compilation(Dto qDto) {
    	try{
			String id_=qDto.getString("id_");
			String compilation_flag_=qDto.getString("compilation_flag_");
			Aos_sys_userPO aos_sys_userPO=new Aos_sys_userPO();
			aos_sys_userPO.setId_(id_);
			aos_sys_userPO.setCompilation_flag_(compilation_flag_);
			aos_sys_userMapper.updateByKey(aos_sys_userPO);
			return true;
		}catch (Exception e){
    		e.printStackTrace();
	 ...
	 * @return
	 */
	public boolean updateUser_checkup(Dto qDto) {
		try{
			String id_=qDto.getString("id_");
			String checkup_flag_=qDto.getString("checkup_flag_");
			Aos_sys_userPO aos_sys_userPO=new Aos_sys_userPO();
			aos_sys_userPO.setId_(id_);
			aos_sys_userPO.setCheckup_flag_(checkup_flag_);
			aos_sys_userMapper.updateByKey(aos_sys_userPO);
			return true;
		}catch (Exception e){
			e.printStackTrace();
