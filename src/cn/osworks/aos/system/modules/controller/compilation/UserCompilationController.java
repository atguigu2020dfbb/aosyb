...
import cn.osworks.aos.system.modules.service.compilation.UserCompilationService;
...
@Controller
@RequestMapping(value = "compilation/user")
public class UserCompilationController {
    @Autowired
    private UserService userService;
    @Autowired
    private UserCompilationService userCompilationService;
    @Autowired
    ...
    public String init(HttpSession session, HttpServletRequest request) {
        ...
        return "aos/compilation/user.jsp";
    }
    /**
     * 查询用户列表
     *
    ...
    public void getModuleTree4Select(HttpServletRequest request, HttpServletResponse response) {
        Dto inDto = Dtos.newDto(request);
        String jsonString = userCompilationService.getModuleTree4Select(inDto);
    ...
    public void saveUserModuleGrantInfo(HttpServletRequest request, HttpServletResponse response) {
        Dto dto = Dtos.newDto(request);
        userCompilationService.saveUserModuleGrantInfo(dto);
