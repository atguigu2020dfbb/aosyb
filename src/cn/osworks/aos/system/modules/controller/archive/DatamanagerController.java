...
import cn.osworks.aos.system.modules.service.archive.*;
 ...
 */
@Controller
@RequestMapping(value = "archive/data_manager")
public class DatamanagerController {
	@Autowired
	private Data_managerService dataService;
	@Autowired
	...
	public String initData(HttpSession session, HttpServletRequest request,
		...
		return "aos/receive/data_manage.jsp";
	...
	public void listTablename(HttpSession session,HttpServletRequest request,HttpServletResponse response){
		List<Archive_tablenamePO> list = dataService.findTablename();
