...
import cn.osworks.aos.system.modules.service.archive.DataReceive_backService;
...
@Controller
@RequestMapping(value = "archive/datareceive_back")
public class DataReceive_backController {
    @Autowired
    public DataReceive_backService data_backService;
    @Autowired
    ...
    public String initData(HttpSession session, HttpServletRequest request,
        ...
        String associations_=qDto.getString("associations_");
         return "aos/archive/datareceive_back.jsp";
