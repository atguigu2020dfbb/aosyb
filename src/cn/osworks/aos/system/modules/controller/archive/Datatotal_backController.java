...
import cn.osworks.aos.system.modules.service.archive.Datatotal_backService;
...
@Controller
@RequestMapping(value = "archive/datatotal_back")
public class Datatotal_backController {
    @Autowired
    public Datatotal_backService data_backService;
    @Autowired
    ...
    public String initData(HttpSession session, HttpServletRequest request,
        ...
        String associations_=qDto.getString("associations_");
         return "aos/archive/datatotal_back.jsp";
