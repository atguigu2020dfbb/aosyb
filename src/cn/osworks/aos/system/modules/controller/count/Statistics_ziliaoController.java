...
import cn.osworks.aos.system.modules.service.count.Statistics_ziliaoService;
 ...
 */
@Controller
@RequestMapping(value = "count/statistics_ziliao")
public class Statistics_ziliaoController {

	@Autowired
	private Statistics_ziliaoService statisticsService;
	/**
	 * 
	 * 页面初始化
	 * 
	...
	public String initData(HttpSession session,HttpServletRequest request,HttpServletResponse response){
		...
		return "aos/count/statistics_ziliao.jsp";
	}
	/**
	 * 选择表
	 *
