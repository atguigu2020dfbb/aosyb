 ...
 */
@Controller
@RequestMapping(value = "count/statistics_temporary")
public class Statistics_TemporaryController {

	@Autowired
	private Statistics_temporaryService statisticsService;
	/**
	 * 
	 * 页面初始化
	 * 
	...
	public String initData(HttpSession session,HttpServletRequest request,HttpServletResponse response){
		...
		return "aos/count/statistics_temporary.jsp";
	}
	/**
	 * 选择表
	 *
