...
import cn.osworks.aos.system.modules.service.count.Statistics_manageService;
import cn.osworks.aos.system.modules.service.count.Statistics_temporaryService;
 ...
 */
@Controller
@RequestMapping(value = "count/statistics_manage")
public class Statistics_manageController {

	@Autowired
	private Statistics_manageService statisticsService;
	/**
	 * 
	 * 页面初始化
	 * 
	...
	public String initData(HttpSession session,HttpServletRequest request,HttpServletResponse response){
		...
		return "aos/count/statistics_manage.jsp";
	}
	/**
	 * 选择表
	 *
