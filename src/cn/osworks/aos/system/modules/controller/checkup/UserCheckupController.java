...
@Controller
@RequestMapping(value = "checkup/user")
public class UserCheckupController {
    @Autowired
    ...
    @RequestMapping(value = "initDatatest")
    public void initDatatest(HttpServletResponse response, HttpServletRequest request) {

        System.out.print("456464654564654");
    }
    /**
     * 页面初始化
     *
    ...
    public String initData(HttpSession session, HttpServletRequest request) {
        ...
        request.setAttribute("task_id_",out.getString("id_"));
        return "aos/details/user.jsp";
    }
    /**
     * 查询用户列表
     *
    ...
    public void getModuleTree4Select(HttpServletRequest request, HttpServletResponse response) {
        Dto inDto = Dtos.newDto(request);
        String jsonString = userCheckupService.getModuleTree4Select(inDto);
