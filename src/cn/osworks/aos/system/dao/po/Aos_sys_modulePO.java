...
public class Aos_sys_modulePO extends PO {
	...
	private Boolean boolean_is_auto_expand_;
	public String getHidden() {
		return hidden;
	}
	public Boolean getBoolean_is_auto_expand_() {
		return boolean_is_auto_expand_;
	}
	public void setBoolean_is_auto_expand_(Boolean Boolean_is_auto_expand_) {
		this.boolean_is_auto_expand_ = boolean_is_auto_expand_;
	}
