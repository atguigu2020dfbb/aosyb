...
<aos:html>
	...
	<aos:onready>
		<aos:viewport layout="border" id="viewport"  autoScroll="true" split="true">
			...
			<aos:gridpanel id="_g_tablename" region="west" url="listTablename.jhtml" height="200"   hidePagebar="true" onrender="_g_tablename_query" autoScroll="true" >
			...
			<aos:formpanel id="_f_info" layout="column" region="center" labelWidth="70" height="200"
				...
				<aos:textfield  name="qzmc" id="qzmc" fieldLabel="全宗名称" margin="50 0 0 0"  columnWidth="0.24" />
				<aos:combobox name="start_listnd" fieldLabel="起始年度" margin="50 0 0 0"  id="start_listnd" value="2000" columnWidth="0.24" allowBlank="false">
					<aos:option value="全部" display="全部" />
					<aos:option value="2000" display="2000" />
					<aos:option value="2001" display="2001" />
					<aos:option value="2002" display="2002" />
					<aos:option value="2003" display="2003" />
					<aos:option value="2004" display="2004" />
					<aos:option value="2005" display="2005" />
					<aos:option value="2006" display="2006" />
					<aos:option value="2007" display="2007" />
					<aos:option value="2008" display="2008" />
					<aos:option value="2009" display="2009" />
					<aos:option value="2010" display="2010" />
					<aos:option value="2011" display="2011" />
					<aos:option value="2012" display="2012" />
					<aos:option value="2013" display="2013" />
					<aos:option value="2014" display="2014" />
					<aos:option value="2015" display="2015" />
					<aos:option value="2016" display="2016" />
					<aos:option value="2017" display="2017" />
					<aos:option value="2018" display="2018" />
					<aos:option value="2019" display="2019" />
				</aos:combobox>
				<aos:combobox name="end_listnd" fieldLabel="终止年度" margin="50 0 0 0"  id="end_listnd" value="2000" columnWidth="0.24" allowBlank="false">
					<aos:option value="全部" display="全部" />
					<aos:option value="2000" display="2000" />
					<aos:option value="2001" display="2001" />
					<aos:option value="2002" display="2002" />
				...
				<aos:button text="统计" onclick="tj3_load" margin="50 0 0 0" ></aos:button>
			</aos:formpanel>
			<!--添加对应的table表格-->
			<aos:panel region="south" height="500" id="grid_nd" contentEl="_div_tips">
