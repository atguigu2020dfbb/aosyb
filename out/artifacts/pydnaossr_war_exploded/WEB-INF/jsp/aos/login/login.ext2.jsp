...
<aos:body class2="bodyclass">
	<div>
		<div class = "div1"> 延边州档案馆数字档案馆综合管理系统</div>
	</div>
	...
	<div>
		<div class = "div2"> 延边朝鲜族自治州档案馆<br>长春市平宇电子科技有限公司联合研制</div>
	</div>
</aos:body>
...
<aos:onready elAuth="false">
	<aos:window id="_w_login" title="欢迎使用${app_name}" autoShow="false" closable="false" modal="false" draggable="false"
		...
		<aos:tabpanel id="_id_tabs" activeTab="0" plain="false" tabBarHeight="30" height="220" anchor="100%" y="true" >
	...
	<script type="text/javascript">
		window.onload = function() {_w_login.show();}
		...
		function _fn_login() {
			...
			AOS.ajax({
				...
				ok : function(data) {
					if (data.appcode === 1) {
						//原始
						//window.location.href = 'index3.jhtml';
						//
