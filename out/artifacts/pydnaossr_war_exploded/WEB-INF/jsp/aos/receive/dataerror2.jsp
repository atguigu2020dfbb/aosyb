...
<aos:html>
	...
	<aos:onready>
		<aos:viewport layout="border" id="viewport">
			<aos:gridpanel id="_g_data" url="listAccounts_error2.jhtml" height="450" region="center" split="true"
						   onrender="_g_data_query" pageSize="${pagesize }"  enableLocking="true">
				<aos:docked>
					...
					<aos:hiddenfield id="tablename" name="tablename" value="${tablename}"/>
					<aos:hiddenfield id="sxjczt" name="sxjczt" value="${sxjczt}"/>
					<aos:hiddenfield id="pch" name="pch" value="${pch}"/>
					...
					<aos:dockeditem text="刷新" icon="refresh.png"  id="_f_refresh_data"
									onclick="_fn_sxjc_properties"  />
				</aos:docked>
			...
			<aos:window id="_w_sxjc_properties" title="四性检测" width="500" height="500" onshow="load_sxjc_properties" autoScroll="true" >
				<aos:gridpanel id="_g_sxjc_properties" autoScroll="true"  enableLocking="true" split="true" splitterBorder="1 0 1 0" width="480" hidePagebar="true" url="getSxjc.jhtml">
			...
			<aos:window id="_w_data_i" title="新增" draggable="false"  closable="false" closeAction="hide"
						autoScroll="true" x="50" width="800" height="500"
						onrender="_w_data_i_render" onshow="open_window">
				<aos:formpanel id="_f_data_i" labelWidth="100" autoScroll="true"  height="800"  width="750" margin="0 0 0 20">
			...
			<aos:window id="_w_pici" title="新增任务" onshow="_new_task">
				<aos:formpanel id="_f_pici" width="420" layout="anchor" labelWidth="90">
					<aos:textfield name="pch" fieldLabel="批次号"  readOnly="true" />
					<aos:textfield name="nd" fieldLabel="年度"   />
					<aos:combobox name="sjygs" value="excel格式" fieldLabel="数据源格式" labelWidth="90">
					...
					<aos:combobox id="bumenmc" fieldLabel="部门名称"
								  name="bumenmc" allowBlank="false"
								  fields="['bmmc','bmbh']"
								  regexText="bmbh" displayField="bmmc"
								  valueField="bmbh"
								  url="querybmmcs.jhtml">
					</aos:combobox>
		...
		<script type="text/javascript">
			...
			//刷新当前数据，也就是进行二次检测
			function _w_refresh_data(){
				var tablename=Ext.getCmp("tablename").getValue();
				var pch=Ext.getCmp("pch").getValue();
				AOS.ajax({
					params:{
						pch:pch,
						tablename:tablename
            ...
            function _w_jccw_report(){
				...
				parent.fnaddtab('456', '错误数据',
						'archive/datatemporary/sxjc_error.jhtml?pch='+pch+'&tablename='+tablename+'&sxjczt='+sxjczt);
			}
		</script>
	</aos:onready>
	<script type="text/javascript">
