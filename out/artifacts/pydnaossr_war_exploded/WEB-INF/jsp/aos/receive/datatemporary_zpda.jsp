...
<aos:html>
    ...
    <aos:onready>
        <aos:viewport layout="border" id="viewport">
            <aos:gridpanel id="_g_receive" url="listReceive_zpda.jhtml" height="250" region="north" splitterBorder="1 0 1 0"
                           split="true"
...
<%--                                    id="_i_jieshou_report"/>--%>
                ...
                <aos:column dataIndex="pch" header="接收编号" width="90"/>
                <aos:column dataIndex="jsnd" header="接收年度" width="90"/>
                <aos:column dataIndex="yjbm" header="移交部门" width="90"/>
                <aos:column dataIndex="yjr" header="移交人" width="90"/>
                <aos:column dataIndex="jjsj" header="交接时间"  width="90"/>
                <aos:column dataIndex="jsr" header="接收人"  width="80"/>
                <aos:column dataIndex="rwmc" header="任务名称" width="200"/>
                <aos:column dataIndex="daml" header="档案门类" width="200" hidden="true"/>
                <aos:column dataIndex="qzsj" header="起止年度" width="80"/>
                <aos:column dataIndex="yjjs" header="永久组数" width="150" hidden="true"/>
                <aos:column dataIndex="cqjs" header="长期组数" width="150" hidden="true"/>
                <aos:column dataIndex="zjs" header="总组数" width="80"/>
                <%--<aos:column dataIndex="z_szhzs" header="数字化组数" width="100"/>
                <aos:column dataIndex="z_szhjs" header="数字化件数" width="100"/>
                <aos:column dataIndex="z_szhzs" header="数字化张数" width="100"/>--%>
                ...
                <aos:column dataIndex="ajszhys" header="数字化张数" width="150"/>


                <aos:column dataIndex="mlsjygs" header="目录类型" width="200"/>
            ...
            <aos:gridpanel id="_g_data" url="listAccounts_temporary.jhtml" height="450" region="center" split="true"
                ...
                <aos:docked>
                    ...
                    <aos:dockeditem text="修改" icon="edit.png" onclick="_w_data_edit_show"></aos:dockeditem>
            ...
            <aos:window id="_w_pici" title="新增任务" > <%--onshow="_new_task"--%>
                <aos:formpanel id="_f_pici" width="800" layout="column" labelWidth="90">
                    ...
                    <aos:combobox name="daml" value="照片档案" fieldLabel="档案门类" columnWidth="0.49"
                                  labelWidth="90">
                    ...
                    <aos:textfield name="z_szhzs" fieldLabel="数字化张数" columnWidth="0.49"/>
                    ...
                    <aos:textfield name="jnszhjs" fieldLabel="数字化件数" columnWidth="0.49"/>
                    <aos:textfield name="ajszhys" fieldLabel="数字化张数" columnWidth="0.49"/>
                    <aos:textfield name="sjygs" fieldLabel="目录类型" value="Excel" columnWidth="0.49"/>
                    <aos:combobox name="dzqwgs" value="单层PDF" fieldLabel="格式类型" labelWidth="90" columnWidth="0.49">
            ...
            <aos:window id="_w_receive_u" title="修改">
                <aos:formpanel id="_f_receive_u" layout="column" width="800">
                    ...
                    <aos:textfield name="jsr" fieldLabel="接收人"  columnWidth="0.49"  />
                    <aos:textfield name="rwmc" fieldLabel="任务名称"  columnWidth="0.98"  />
                    <aos:combobox name="daml" value="音频档案" fieldLabel="档案门类" columnWidth="0.49"
                                  labelWidth="100">
                        <aos:option value="文书档案" display="文书档案"/>
                        <aos:option value="会计档案" display="会计档案"/>
                        <aos:option value="人事档案" display="人事档案"/>
                    ...
                    <aos:textfield name="dzqwrl" fieldLabel="容量大小" columnWidth="0.475"/>
                    <aos:displayfield value="GB" columnWidth="0.02"/>
                    <aos:combobox name="boolean_check" value="是" fieldLabel="是否检测" columnWidth="0.49" labelWidth="100"
                                  >
                        <aos:option value="是" display="是"/>
                        <aos:option value="否" display="否"/>
                    </aos:combobox>
