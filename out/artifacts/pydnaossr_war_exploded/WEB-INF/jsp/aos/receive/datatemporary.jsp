...
<aos:html>
    ...
    <aos:onready>
        <aos:viewport layout="border" id="viewport">
            <aos:gridpanel id="_g_receive" url="listReceive.jhtml" height="250" region="north" splitterBorder="1 0 1 0"
                           split="true"
                           onrender="_g_receive_query" pageSize="${pagesize}" onitemclick="get_a_receive"
                           enableLocking="false">
                <aos:docked>
                    ...
                    <aos:hiddenfield id="ndd" name="ndd" value="${ndd}"/>
                    <!-- 存储当前页面的查询条件 -->
                    ...
                    <aos:button text="导入" icon="folder8.png" scale="small" margin="0 0 0 0" id="importt">
                        <aos:menu plain="false">
                            <aos:menuitem text="导入目录" icon="folder8.png" onclick="_w_import_show"
                                          id="_f_import_message"/>
                            <aos:menuitem text="导入全文" icon="folder8.png" onclick="_w_import_path_show"
...
<%--                    <aos:dockeditem text="接收报告" icon="more/network-receive.png" onclick="_w_receive_report" --%>
<%--                                    id="_i_jieshou_report"/>--%>
                </aos:docked>
                ...
                <aos:column dataIndex="rwmc" header="任务名称" width="150"/>
                <aos:column dataIndex="qzh" header="全宗号"/>
                <aos:column dataIndex="qzdw" header="全宗单位" width="200"/>
                <aos:column dataIndex="daml" header="档案门类" width="200"/>
                <aos:column dataIndex="qznd" header="起止年度" width="200"/>

                <aos:column dataIndex="yjjs" header="永久卷数" />
                <aos:column dataIndex="cqjs" header="长期卷数" />
                <aos:column dataIndex="zjs" header="总卷数" />

                <aos:column dataIndex="jnyjjs" header="卷内永久件数" width="150"/>
                <aos:column dataIndex="jncqjs" header="卷内长期件数" width="150"/>
                <aos:column dataIndex="jnzjs" header="卷内总件数" width="150"/>
                <aos:column dataIndex="jnszhjs" header="卷内数字化件数" width="150"/>

                <aos:column dataIndex="ajzys" header="案卷总页数" width="150"/>
                <aos:column dataIndex="ajszhys" header="案卷数字化页数" width="150"/>

                <aos:column dataIndex="gdyjjs" header="归档永久件数" width="150"/>
                <aos:column dataIndex="gddqjs" header="归档定期件数" width="150"/>
                <aos:column dataIndex="gdzjs" header="归档总件数" width="150"/>
                <aos:column dataIndex="gdszhjs" header="归档数字化件数" width="150"/>
                <aos:column dataIndex="gdzys" header="归档总页数" width="150"/>
                <aos:column dataIndex="gdszhys" header="归档数字化页数" width="150"/>

                <aos:column dataIndex="dzmlgs" header="目录类型" width="200"/>
                ...
                <aos:column dataIndex="cjr" header="创建人" hidden="true"/>
            ...
            <aos:gridpanel id="_g_data" url="listAccounts_temporary.jhtml" height="450" region="center" split="true"
                ...
                <aos:docked>
                    ...
                    <aos:dockeditem text="修改" icon="edit.png" onclick="_w_data_edit_show" id="_f_editi_message"/>
                ...
                <aos:tabpanel id="_tabpanel3" region="center" activeTab="0"
                    ...
                    <aos:tab title="记录处理" id="_tab_tablefield">
                        <aos:formpanel id="_f_tablefield" layout="column" columnWidth="1">
                            ...
                            <aos:combobox name="condition" id="condition"
                            ...
                            <aos:textfield name="repair_long" id="repair_log"
                                           columnWidth="0.19"/>
            ...
            <aos:window id="_w_pici" title="新增任务" onshow="_new_task" autoScroll="true">
                <aos:formpanel id="_f_pici" width="800" layout="column" labelWidth="100" autoScroll="true">
                    ...
                    <aos:textfield name="jsr" fieldLabel="接收人" columnWidth="0.49" value="${user_cn}"/>
                    ...
                    <aos:numberfield labelWidth="100" name="jnyjjs"  fieldLabel="卷内永久件数" value="0"
                                     minValue="0" maxValue="500000" columnWidth="0.49"/>
                    <aos:numberfield labelWidth="100" name="jncqjs" fieldLabel="卷内长期件数" value="0"
                                     minValue="0" maxValue="500000" columnWidth="0.49"/>
                    <aos:numberfield labelWidth="100" name="jnzjs" fieldLabel="卷内总件数" value="0"
                                     minValue="0" maxValue="500000" columnWidth="0.49"/>
                    <aos:numberfield labelWidth="100" name="jnszhjs" fieldLabel="卷内数字化件数" value="0"
                                     minValue="0" maxValue="500000" columnWidth="0.49"/>
                    <aos:numberfield labelWidth="100" name="ajzys" fieldLabel="案卷总页数" value="0"
                                     minValue="0" maxValue="500000" columnWidth="0.49"/>
                    <aos:numberfield labelWidth="100" name="ajszhys" fieldLabel="案卷数字化页数" value="0"
                                     minValue="0" maxValue="500000" columnWidth="0.49"/>
                    <aos:numberfield labelWidth="100" name="gdyjjs" fieldLabel="归档永久件数" value="0"
                                     minValue="0" maxValue="500000" columnWidth="0.49"/>
                    <aos:numberfield labelWidth="100" name="gddqjs" fieldLabel="归档定期件数" value="0"
                                     minValue="0" maxValue="500000" columnWidth="0.49"/>
                    <aos:numberfield  labelWidth="100" name="gdzjs" fieldLabel="归档总件数" value="0"
                                     minValue="0" maxValue="500000" columnWidth="0.49"/>
                    <aos:numberfield labelWidth="100" name="gdszhjs" fieldLabel="归档数字化件数" value="0"
                                     minValue="0" maxValue="500000" columnWidth="0.49"/>
                    <aos:numberfield labelWidth="100" name="gdzys" fieldLabel="归档总页数" value="0"
                                     minValue="0" maxValue="500000" columnWidth="0.49"/>
                    <aos:numberfield labelWidth="100" name="gdszhys" fieldLabel="归档数字化页数" value="0"
                                     minValue="0" maxValue="500000" columnWidth="0.49"/>

                    <aos:textfield name="dzmlgs" fieldLabel="目录类型" columnWidth="0.49"/>
                    <aos:combobox name="dzqwgs" value="单层PDF" fieldLabel="格式类型" labelWidth="100" columnWidth="0.49">
                        <aos:option value="JPG" display="JPG"/>
                        <aos:option value="TIFF" display="TIFF"/>
                        <aos:option value="单层PDF" display="单层PDF"/>
                        <aos:option value="双层PDF" display="双层PDF"/>
                    </aos:combobox>
                    <aos:textfield name="dzqwrl" fieldLabel="容量大小" columnWidth="0.47"/>
                    <aos:displayfield value="GB" columnWidth="0.02"/>
                    ...
                    <aos:textfield name="user_cn" fieldLabel="录入人" columnWidth="0.49" value="${user_cn}"
                                   readOnly="true"/>
        ...
        <script type="text/javascript">
            ...
            function add_jscount() {
                var yjjs = Ext.getCmp('_f_pici').getForm().findField('yjjs').getValue();
                var cqjs = Ext.getCmp('_f_pici').getForm().findField('cqjs').getValue();
                var jscount = parseFloat(yjjs) + parseFloat(cqjs);
                Ext.getCmp('_f_pici').getForm().findField('zjs').setValue(jscount);
            }
            function add_jiscount() {
                var yjjis = Ext.getCmp('_f_pici').getForm().findField('yjjis').getValue();
                var dqjs = Ext.getCmp('_f_pici').getForm().findField('dqjs').getValue();
                var jiscount = parseFloat(yjjis)  + parseFloat(dqjs) ;
                Ext.getCmp('_f_pici').getForm().findField('zjis').setValue(jiscount);
            }
            function update_jscount() {
                var yjjs = Ext.getCmp('_f_receive_u').getForm().findField('yjjs').getValue();
                var cqjs = Ext.getCmp('_f_receive_u').getForm().findField('cqjs').getValue();
                var jscount = parseFloat(yjjs) + parseFloat(cqjs);
                Ext.getCmp('_f_receive_u').getForm().findField('zjs').setValue(jscount);

            }
            function update_jiscount() {
                var yjjis = Ext.getCmp('_f_receive_u').getForm().findField('yjjis').getValue();
                var dqjs = Ext.getCmp('_f_receive_u').getForm().findField('dqjs').getValue();
                var jiscount = parseFloat(yjjis) + parseFloat(dqjs);
                Ext.getCmp('_f_receive_u').getForm().findField('zjis').setValue(jiscount);
            }
            function open_tab(){
            ...
            function _w_data_i_from_onshow() {
                if (typeof (AOS.selectone(_g_data_from)) != 'undefined') {
                    AOS.ajax({
                        params: {
                            id_: AOS.selectone(_g_data_from).data.id_,
            ...
            function _g_receive_pici() {
                ...
                AOS.confirm(msg, function (btn) {
                    ...
                    var ndd = Ext.getCmp("ndd").getValue();
                    AOS.ajax({
                        params: {
            ...
            function _save_next_kf_message() {
                ...
                var tablename = Ext.getCmp("tablename").getValue();
                var aos_module_id_ = Ext.getCmp("aos_module_id_").getValue();
                var nd = Ext.getCmp("ndd").getValue();
                AOS.ajax({
                ...
                AOS.confirm(msg, function (btn) {
                    ...
                    if (boolean_examine == "否") {
                        ...
                        if (flag_submit == "已提交" && flag_examine == "已通过") {
                            ...
                            AOS.ajax({
                                params: {id_: id_, tablename: tablename, bmbh: bmbh, bmmc: bmmc, pch: pch, nd: ndd},
                                url: 'temporaryToreceiveData.jhtml',
                                ok: function (data) {
                                    AOS.tip(data.appmsg);
                                    _g_receive_store.reload();
            ...
            function _new_task() {
                ...
                var nd = Ext.getCmp("ndd").getValue();
                _f_pici.form.findField("nd").setValue(nd);
                _f_pici.form.findField("cjr").setValue("<%=session.getAttribute("user")%>");
                AOS.ajax({
                    params: {treename: treename, lx: lx, nd: Ext.getCmp("ndd").getValue()},
                    ...
                    ok: function (data) {
                        ...
                        //_f_pici.form.findField("pch").setValue("DZ"+data.dictionary+yesday+data.index);
                    }
                });
            }
