...
<aos:onready>
	<aos:viewport layout="border">
		...
		<aos:panel region="east"  split="true" width="800">
			...
			<aos:docked dock="bottom" ui="footer">
				...
				<aos:dockeditem onclick="_last_save_compilation_details" text="上报" icon="ok.png" />
			</aos:docked>
		</aos:panel>
		...
		<aos:window id="_w_last_compilation_message" title="终审人终审说明" width="500" >
	...
	<script type="text/javascript">
		...
		function load_hegao_message(){
			...
			AOS.ajax({
				...
				url: 'getcompilation_hegao_message.jhtml',
				ok: function (data) {
					Ext.getCmp("compilation_hegao_message").setValue(data.appmsg);
				}
			});
		}
		function load_jiaodui_message(){
			AOS.ajax({
				params: {
					type:3,
					topic_id_: topic_id_.getValue()
				},
				url: 'getcompilation_jiaodui_message.jhtml',
				ok: function (data) {
					Ext.getCmp("compilation_jiaodui_message").setValue(data.appmsg);
				}
			});
		}
		...
		function _save_last_compilation_message(){
			...
			AOS.ajax({
				...
				params:{
					...
					compilation_message:Ext.getCmp("compilation_hegao_message").getValue(),
					topic_id_:topic_id_.getValue(),
					cascode_id_:cascode_id_,aos_module_id_:aos_module_id_,
