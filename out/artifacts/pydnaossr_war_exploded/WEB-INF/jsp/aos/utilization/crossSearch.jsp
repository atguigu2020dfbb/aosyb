...
<aos:html>
    ...
    <aos:onready>
        <aos:viewport layout="border">
            <aos:gridpanel id="_g_param" url="listAccounts_all.jhtml"  features="true"
                ...
                <aos:docked forceBoder="0 0 1 0">
                    ...
                    <aos:textfield  fieldLabel="跨库检索"  margin="0 0 0 0" emptyText="请输入检索内容" height="30" id="text" name="text" allowBlank="true"
                ...
                <aos:column dataIndex="_path" header="附件" hidden="true"  />
                <aos:column dataIndex="dh" header="档号" width="150"/>
                <aos:column dataIndex="tm" header="题名" width="300"/>
                <aos:column dataIndex="tabledesc" header="档案门类"  width="100"/>
                <aos:column dataIndex="tablename" header="档案门类" hidden="true" width="300"/>
        ...
        <script type="text/javascript">
            ...
            function w_data_path_onshow() {
                var record = AOS.selectone(_g_param);
                var tablenameId=record.data.tablename;
