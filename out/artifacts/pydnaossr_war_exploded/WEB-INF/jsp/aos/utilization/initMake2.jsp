...
<aos:html>
    <aos:head title="拍照">
        ...
        <aos:include js="${cxt}/static/js/qwebchannel.js" />
    </aos:head>
    <aos:body>
        ...
        <img id="bigPriDev" width="640" height="480"  style="float:left;"/></img>
        ...
        <label id="lab1" style="margin-top: 0px;margin-left: 0px;float:left;">设备1</label>
        <br/>
        <br/>
        <label id="lab5">图片类型</label>
        <select id="priModelList" style="width: 100px" ></select>
        <br/>
        <br/>
        <label id="lab6" >分&nbsp 辨&nbsp率</label>
        <select id="priResolutionList" style="width: 100px" ></select>
        <br/>
        <br/>
        <label id="lab7" >尺&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp寸</label><select id="setScanSize" style="width: 100px" ></select>
        <br/>
        <br/>
        <input id="openPriVideo" type="button" value="打开" />&nbsp&nbsp&nbsp
        <input id="closePriVideo" type="button" value="关闭"  />&nbsp&nbsp&nbsp
        <input id="photographPri" type="button" value="拍照"  />&nbsp&nbsp&nbsp
    ...
    <aos:onready>
        <aos:viewport layout="border">
                <aos:docked>
                    <aos:dockeditem xtype="tbtext" text="拍照介绍信"/>

                    <aos:button text="新增登记" id="bigSubDev" hidden="true" />
                    <aos:dockeditem text="新增登记" id="devPhoto" icon="add.png" onclick="_w_make_show"/>
                    <aos:dockeditem text="新增登记" id="devPhoto2" icon="add.png" onclick="_w_make_show"/>
                    ...
                    <aos:dockeditem text="介绍信" icon="del.png" onclick="_g_make_jieshaoxin"/>
