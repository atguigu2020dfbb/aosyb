...
<aos:html>
	...
	<aos:onready>
		<aos:viewport layout="fit">
			<aos:gridpanel id="_g_topic" region="center" url="listtopic.jhtml" onrender="_load_listtopic"
				...
				<aos:docked forceBoder="0 0 1 0">
					...
					<aos:hiddenfield name="user_en" id="user_en" value="${user_en}"/>
			...
			<aos:window id="_w_add_topic" title="新增专题" onshow="_w_topic_onshow">
				<aos:formpanel id="_f_add_topic" width="420" layout="column" labelWidth="90" >
					...
					<aos:textfield name="create_person" id="create_person" fieldLabel="创建人"  columnWidth="0.99"/>
			...
			<aos:window id="_w_select_archive" title="鉴定数据选择" onshow="_w_select_archive_onshow" width="800" height="500">
				...
				<aos:tabpanel id="_tabpanel_select" region="center" activeTab="0"
					...
					<aos:tab title="列表式搜索" id="_tab_select_org">
						<aos:formpanel id="_f_select_query" layout="column" columnWidth="1">
							...
							<aos:combobox name="filedname2" id="filedname2"  labelWidth="20" columnWidth="0.2" url="getComboboxList.jhtml"  fields="['fieldenname','fieldcnname']"
										  displayField="fieldcnname"
							...
							<aos:combobox name="filedname3" id="filedname3"  labelWidth="20" columnWidth="0.2" url="getComboboxList.jhtml"  fields="['fieldenname','fieldcnname']"
										  displayField="fieldcnname"
										  valueField="fieldenname" >
							</aos:combobox>
							...
							<aos:combobox name="filedname4" id="filedname4"  labelWidth="20" columnWidth="0.2" url="getComboboxList.jhtml"  fields="['fieldenname','fieldcnname']"
										  displayField="fieldcnname"
										  valueField="fieldenname" >
							</aos:combobox>
							...
							<aos:combobox name="filedname5" id="filedname5"  labelWidth="20" columnWidth="0.2" url="getComboboxList.jhtml"  fields="['fieldenname','fieldcnname']"
										  displayField="fieldcnname"
										  valueField="fieldenname" >
							</aos:combobox>
		...
		<script>
			...
			function ok_save_All_archive(){
				...
				AOS.ajax({
					...
					ok: function(data){
						...
						_f_add_topic.getForm().findField('dhs').setValue(dhs);
			...
			function _w_topic_onshow(){
				_f_add_topic.form.findField("create_person").setValue(Ext.getCmp("user_en").getValue());
			}
			...
			function ok_selectall(){
				//走后台得到得到当前条件的所有条目的id值
				var row=_g_select_archive_store;
				alert(123);
			}
			//保存当前选中的档案信息
			function ok_save_archive(){
				...
				_f_add_topic.getForm().findField('ids').setValue(ids);
				_f_add_topic.getForm().findField('dhs').setValue(ids);
				_w_select_archive.hide();
			}
