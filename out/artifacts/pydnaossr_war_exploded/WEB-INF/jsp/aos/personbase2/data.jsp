		...
		<script type="text/javascript">
			...
			function _w_data_show() {
				...
				if(treename!=null&&treename!=""&&treename==="全部"){
					...
					Ext.getCmp('_f_data_i').getForm().findField('qzmc').setValue(treename.getValue());
					Ext.getCmp('_f_data_i').getForm().findField('qzh').setValue(treenumber.getValue());
				}
			}
