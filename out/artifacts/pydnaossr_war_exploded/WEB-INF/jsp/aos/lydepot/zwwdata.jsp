...
<aos:html>
    ...
    <aos:onready>
        <aos:viewport layout="border">
            <aos:gridpanel id="_g_param" url="listAccounts_zww.jhtml" region="center" onitemclick="itemclick"  rowclass="true" onrender="_w_params_show" onitemdblclick="fn_g_data">
        ...
        <aos:window id="_w_select_edit_archive" title="政务网数据选择"  width="800" height="500" onshow="load_archive">
        ...
        <script type="text/javascript">
            ...
            function _w_picture_show() {
                ...
                var uploadPanel= new Ext.ux.uploadPanel.UploadPanel({
                    ...
                    upload_complete_handler : function(file){
                        ...
                        var table="<%=request.getAttribute("tablename")%>";
                        AOS.ajax({
                            params: {tid: record.data.tablename_id,tablename:table},
                            url: 'getPath.jhtml',
                            ok: function (data) {
                                for(i in data){
            ...
            function fn_onselect(e){
                var user=Ext.getCmp("user").getValue();
                window.location.href="init.jhtml?lx=zww&user="+user+"&tablename="+e.value+"&tabledesc="+e.rawValue+"&recordid="+_recordid.getValue();
            }
