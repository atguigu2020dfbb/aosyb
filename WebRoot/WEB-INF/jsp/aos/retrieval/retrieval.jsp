...
<aos:onready>
	...
	<script>
        ...
        parent.fnaddtab(row.data.id, '电子文件',
							'archive/data/openFile.jhtml?id='+row.data.id_+'&tablename='+row.data.tablename+"'");
        }
		...
		if(columnIndex === 0){
			//parent.fnaddtab('111', '电子文件','archive/data/openPdfFile.jhtml?id='+id+'&tid='+tid+'&tablename='+tablename+'&type=pdf');
				parent.parent.fnaddtab(record.data.id_, '电子文件',
						'retrieval/retrieval/openPdfFile.jhtml?id='+record.data.id_+'&tid='+id+'&type=pdf'+'&tablename='+tablename);
