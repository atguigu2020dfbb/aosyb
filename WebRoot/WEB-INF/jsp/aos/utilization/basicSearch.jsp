...
<aos:html>
    ...
    <aos:onready>
        <aos:viewport layout="border">
            <aos:gridpanel id="_g_param" url="listAccounts.jhtml"  features="true"   region="center" onitemclick="itemclick"  rowclass="true" onrender="_w_params_show" onitemdblclick="fn_g_data">
                <aos:docked forceBoder="0 0 1 0">
                    ...
                    <aos:hiddenfield  id="bj" name="bj" value="${bj}"/>
                    ...
                    <aos:triggerfield fieldLabel="登记编号" name="djbh" id="_djbh" value="${djbh}" editable="false" trigger1Cls="x-form-search-trigger"
                                      onTrigger1Click="_w_account_find_show" columnWidth="0.49" />

                    <aos:dockeditem onclick="_w_query_show" text="查询条件" icon="query.png" />
                    <aos:dockeditem onclick="_w_picture_show" text="电子文件" icon="picture.png" />
                    ...
                    <aos:dockeditem id="nftg" text="能否提供" icon="icon134.png" >
                        <aos:menu plain="true">
            ...
            <aos:window id="_w_query_q" title="查询" width="720" autoScroll="true"
                ...
                <aos:tab title="列表式搜索" id="_tab_org">
                    <aos:formpanel id="_f_query2" layout="column" columnWidth="1">
                        ...
                        <c:forEach var="fieldss" items="${field_childrenDtos}" end="7"
                            ...
                            <aos:combobox id="filedname${listSearch.count}"
                                          ...
                                          url="queryFields_children.jhtml?tablename=${tablename}">
                            </aos:combobox>
        ...
        >
            ...
            <aos:docked dock="bottom" ui="footer">
                ...
                <aos:dockeditem xtype="button" text="领导核批" icon="folder23.png" onclick="f_examine_save"/>
        ...
        <script type="text/javascript">
            ...
            window.onload=function(){
                ...
                if(bj==1){
                    ...
                    Ext.getCmp("_djbh").hide();
                    Ext.getCmp("nftg").hide();
                    Ext.getCmp("cxjg").hide();
                }
            }
            ...
            function _f_data_query2(){
                ...
                params["querySession"]=Ext.getCmp("querySession").getValue()+query;
                params["flag"]=1;
            ...
            function _yes_query(){
                ...
                AOS.ajax({
                    ...
                    params:{
                        ...
                        aos_rows_: selection,
                        //tid:record.data.id_,
                        tablename_cn:Ext.getCmp("listTablename").getRawValue(),
                        tablename:Ext.getCmp("tablename").getValue(),
                        cxjg:1
                    },
                    ok:function (data) {
            ...
            function fn_onselect(e){
                var user=Ext.getCmp("user").getValue();
                window.location.href="basicSearchTable.jhtml?user="+user+"&tablename="+e.value+"&tabledesc="+e.rawValue+"&djbh="+_djbh.getValue()+"&recordid="+_recordid.getValue();
            }
            function _f_data_query(){
                ...
                params["querySession"]=Ext.getCmp("querySession").getValue();
                params["flag"]=1;
                _g_param_store.getProxy().extraParams = params;
                _g_param_store.load();
                ...
                AOS.ajax({
                    ...
                    ok: function (data) {
                        //此时在隐藏域中存入查询条件
                        Ext.getCmp("querySession").setValue(Ext.getCmp("querySession").getValue()+" "+data.appmsg);
                    }
                });
                _w_query_q.hide();
                AOS.reset(_f_query2);
