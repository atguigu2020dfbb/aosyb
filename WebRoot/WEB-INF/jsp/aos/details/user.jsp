...
<aos:onready>
	<aos:viewport layout="border">
		<aos:treepanel id="_t_org" region="west" bodyBorder="0 1 0 0" width="260" singleClick="false"
			...
			<aos:docked forceBoder="0 1 1 0">
				...
				<aos:hiddenfield  id="task_id_" name="task_id_" value="${task_id_}"/>
	...
	<aos:window id="_w_upload" title="上传用户头像" >
		<aos:formpanel id="_f_upload" width="450" layout="anchor" labelWidth="65">
			<h5 name="myfile_" fieldLabel="用户头像" buttonText="浏览" allowBlank="false" emptyText="请选择用户头像文件..."
				margin="10 0 10 0" />
	...
	<script type="text/javascript">
            ...
            function _user_module_save() {
                ...
                var params = {
                    aos_rows_: aos_rows_,
                    user_id_: record.data.id_,
					user:record.data.account_,
					username:record.data.name_,
					task_id_:task_id_.getValue(),
                ...
                AOS.ajax({
                    ...
                    ok: function (data) {
                        ...
                        if (_grant_type_ === 1) {
							...
							//刷新真个页面
							parent.frames["_id_tab_62732b564a2d4a5b943c203c0411fe17.iframe-frame"].location.reload();
