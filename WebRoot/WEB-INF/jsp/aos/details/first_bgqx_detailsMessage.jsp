		...
		<aos:viewport layout="border">
			...
			<aos:panel region="east" id="edit_message"  split="true" >
				...
				<aos:docked dock="bottom" ui="footer">
					...
					<aos:dockeditem onclick="_first_save_jiazhi_details" text="提交复审" icon="ok.png" />
				</aos:docked>
			</aos:panel>
			...
			<aos:window id="_w_first_jiazhi_message" title="初鉴价值鉴定说明" width="500" >
				<aos:formpanel  id="_f_first_jiazhi_message" width="480">
					<aos:textareafield fieldLabel="操作说明" id="first_jiazhi_message" value="鉴定初审已完毕，请复审。"  name="first_jiazhi_message" width="450" allowBlank="false"/>
				</aos:formpanel>
				<aos:docked dock="bottom" ui="footer">
					<aos:dockeditem xtype="tbfill" />
					<aos:dockeditem text="确定" onclick="_save_first_jiazhi_message" icon="ok.png" />
					<aos:dockeditem onclick="#_w_first_jiazhi_message.hide();" text="关闭"
									icon="close.png" />
				</aos:docked>
			</aos:window>
		</aos:viewport>
...
//把这个值存放到数据库中
			...
			function _first_save_jiazhi_details(){
				...
				Ext.getCmp("first_jiazhi_message").setValue("鉴定初审已完毕，请复审。");
			}
