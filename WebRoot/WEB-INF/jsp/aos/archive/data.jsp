...
<aos:html>
    ...
    <aos:onready>
        <aos:viewport layout="border">
            <aos:gridpanel id="_g_data" url="listAccounts.jhtml" region="center" features="true"
                ...
                <aos:docked forceBoder="1 0 1 0">
                    ...
                    <aos:dockeditem text="数据核检" icon="more/tools-check-spelling.png" onclick="_w_check_data"
                                    id="_f_check_data"/>
        ...
        <aos:window id="_w_print" title="打印列表" height="400" width="300"
            ...
            <aos:docked dock="bottom" ui="footer">
                <aos:dockeditem xtype="tbfill"/>
                <aos:dockeditem xtype="button" text="预览" icon="query.png"
                                onclick="look_report"/>
            ...
            function _w_import_show() {
                ...
                $(document).ready(function () {
                    $("#file").fileinput({
                        ...
                        allowedFileExtensions: ['xls', 'xlsx', 'jpg', 'gif', 'png', 'pdf', 'tif','mp4'],//接收的文件后缀
            ...
            function _fileupload_show() {
                ...
                if (AOS.empty(record)) {
                    ...
                    $("#file").fileinput({
                        ...
                        allowedFileExtensions: ['jpg', 'gif', 'png', 'pdf', 'tif','mp4'],//接收的文件后缀
                        showRemove: true,//显示删除按钮
                        showUpload: true, //是否显示上传按钮
                        showCaption: true,//是否显示标题
                        browseClass: "btn btn-primary btn-xs", //按钮样式
