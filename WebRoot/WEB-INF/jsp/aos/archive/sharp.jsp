...
<aos:html>
	...
	<aos:onready>
		<aos:viewport layout="border">
			<aos:gridpanel id="_g_data" url="listAccounts.jhtml" region="north"
						   autoScroll="true" enableLocking="true" pageSize="20" height="500"
						   onrender="_w_tablename_show" xtype="true">
				<aos:docked forceBoder="0 0 1 0">
					<aos:dockeditem xtype="tbtext" text="档案借阅" />
			...
			<aos:gridpanel id="_g_center" region="center" autoScroll="true"
						   hidePagebar="true">
				<aos:docked forceBoder="1 0 1 0">
					<aos:dockeditem xtype="tbtext" text="档案篮" />
					<aos:dockeditem text="删除" icon="basket.png"
									onclick="_w_delete_archive" />
					<aos:dockeditem text="清空" icon="basket.png"
									onclick="_w_deleteAll_archive" />
					<aos:dockeditem text="添加" icon="more/view-history.png"
									onclick="_w_remove_archvie" />
					<aos:dockeditem text="借阅申请" icon="more/view-history.png"
									onclick="_w_borrow_application" />
				</aos:docked>
				<aos:column type="rowno" />
				<aos:selmodel type="row" mode="multi" />
				<aos:column dataIndex="id_" header="流水号" hidden="true" />
			...
			<aos:window title="借阅申请单" width="850" layout="fit" center="true"
						maximizable="true" id="_w_application" onshow="_borrow_load">
				<aos:formpanel id="_f_application" layout="column" autoScroll="true"
							   labelWidth="70">
					<aos:fieldset title="借阅" columnWidth="1" labelWidth="70">
						<aos:textfield fieldLabel="借阅单号" allowBlank="false" readOnly="true"
									   name="borrow_card" id="borrow_card" columnWidth="0.49" />
						<aos:textfield fieldLabel="登录号" allowBlank="false" readOnly="true"
									   name="login_card" id="login_card" columnWidth="0.49" />
					</aos:fieldset>
					<aos:fieldset title="基本信息" labelWidth="70" columnWidth="1">
						<aos:hiddenfield name="data_ids_" id="data_ids_" />
						<aos:textfield name="borrow_purpose" fieldLabel="借阅目的"
									   columnWidth="0.49" id="borrow_purpose"/>
						<aos:textfield name="borrow_day" fieldLabel="借阅天数" id="borrow_day"
									   columnWidth="0.49"  onblur="get_expire_date" allowBlank="false"/>
						<aos:checkboxgroup id="borrow_type_" fieldLabel="利用方式" columns="[120,120,120]" columnWidth="0.99">
							<aos:checkbox name="c1" boxLabel="浏览" checked="true"/>
							<aos:checkbox name="c1" boxLabel="下载" checked="true" />
							<aos:checkbox name="c1" boxLabel="打印" />
						</aos:checkboxgroup>
						<aos:textareafield name="borrow_explain" id="borrow_explain" fieldLabel="备注"
										   columnWidth="0.98" />
						<aos:textfield name="checked_person" id="checked_person" fieldLabel="审核人"
									   columnWidth="1" readOnly="true" value="管理员"/>
						<aos:textfield name="borrow_person" id="borrow_person"
									   fieldLabel="借阅申请人" readOnly="true" columnWidth="0.33" />
						<aos:textfield name="borrow_date" id="borrow_date"
									   fieldLabel="申请日期" readOnly="true" columnWidth="0.33" />
						<aos:hiddenfield name="expire_date" id="expire_date" />
						<aos:textfield name="borrow_ip" id="borrow_ip"
									   fieldLabel="申请机器"   readOnly="true" columnWidth="0.33" />
					</aos:fieldset>
				</aos:formpanel>
				<aos:docked dock="bottom" ui="footer">
					<aos:dockeditem xtype="tbfill" />
					<aos:dockeditem xtype="button" text="提交申请" icon="ok.png"
									onclick="submit_application" />
					<aos:dockeditem xtype="button" text="关闭" icon="close.png"
									onclick="#_w_application.hide()" />
				</aos:docked>
			</aos:window>
			<aos:window id="_w_my_borrow" title="我的借阅" autoScroll="true"
						width="800" border="true" height="500">
				<aos:formpanel id="_f_my_borrow" width="800" layout="column"
							   labelWidth="90">
					<aos:combobox fieldLabel="数据表" name="tableTemplate"
								  id="tableTemplate" fields="[ 'value', 'display', 'tablename']"
								  editable="false" columnWidth="0.3" url="listComboBoxid.jhtml"
								  displayField="display" valueField="tablename" />
					<aos:textfield name="borrow_order" emptyText="借阅说明"
								   columnWidth="0.3" id="borrow_order" />
					<aos:button text="查询" icon="query.png" scale="small"
								margin="0 0 0 0" onclick="get_my_borrow_data" />
				</aos:formpanel>
				<aos:gridpanel id="_g_my_borrow" region="east" url="myborrow.jhtml"
					...
					<aos:docked forceBoder="0 0 1 0">
						...
						<aos:dockeditem text="续借" icon="query.png"
										onclick="_w_renewal_show" />
						<aos:dockeditem text="归还" icon="query.png"
										onclick="_w_return_archive" />
					</aos:docked>
					<aos:column type="rowno" />
					<aos:column header="流水号" dataIndex="id_" hidden="true" />
					<aos:column header="借阅单号" dataIndex="borrow_card" width="60" />
					<aos:column header="登录号" dataIndex="login_card" width="90" />
					<aos:column header="借阅目的" dataIndex="borrow_purpose" width="90" />
					<aos:column header="借阅天数" dataIndex="borrow_day" width="90" />
					<aos:column header="利用方式" dataIndex="borrow_type_" width="60" />
					<aos:column header="备注" dataIndex="borrow_explain" width="90" />
					<aos:column header="审核人" dataIndex="checked_person" width="150" />
					<aos:column header="借阅申请人" dataIndex="borrow_person" width="90" />
					<aos:column header="申请日期" dataIndex="borrow_date" width="90" />
					<aos:column header="到期日期" dataIndex="expire_date" hidden="true" width="90" />
					<aos:column header="申请机器" dataIndex="borrow_ip" width="90" />
					<aos:column header="表明" dataIndex="tablename" width="90" />
					<aos:column header="档案状态" dataIndex="borrow_status" width="90"
								rendererFn="fn_borrow_render" />
					<aos:column header="审批状态" dataIndex="approval_status" width="90"
								rendererFn="fn_approval_render" />
				</aos:gridpanel>
				<aos:docked dock="bottom" ui="footer">
					<aos:dockeditem xtype="tbfill" />
					<aos:dockeditem onclick="#_w_my_borrow.close();" text="关闭"
									icon="close.png" />
				</aos:docked>
			</aos:window>
			<aos:window id="_w_details" title="详情">
				<aos:formpanel id="_g_details" width="500" layout="anchor"
							   labelWidth="90">
					<aos:textfield name="borrow_card" fieldLabel="借阅单号" readOnly="true" />
					<aos:textfield name="login_card" fieldLabel="登录号" readOnly="true" />
					<aos:textfield name="borrow_purpose" fieldLabel="借阅目的" readOnly="true" />
					<aos:textfield name="borrow_day" fieldLabel="借阅天数" readOnly="true" />
					<aos:checkboxgroup id="borrow_type2_" fieldLabel="利用方式" columns="[120,120,120]" columnWidth="0.99">
						<aos:checkbox name="c1" boxLabel="浏览"/>
						<aos:checkbox name="c1" boxLabel="下载" />
						<aos:checkbox name="c1" boxLabel="打印" />
					</aos:checkboxgroup>
					<aos:textfield name="borrow_explain" fieldLabel="备注"
								   readOnly="true" />
					<aos:textfield name="checked_person" fieldLabel="审核人"
								   readOnly="true" />
					<aos:textfield name="borrow_person" fieldLabel="借阅申请人" readOnly="true" />
					<aos:textfield name="borrow_date" fieldLabel="借阅日期" readOnly="true" />
					<aos:textfield name="borrow_ip" fieldLabel="申请机器" readOnly="true" />
					<aos:textfield name="tablename" fieldLabel="数据表" readOnly="true" />
				</aos:formpanel>
				<aos:docked dock="bottom" ui="footer">
					<aos:dockeditem xtype="tbfill" />
					<aos:dockeditem onclick="#_w_details.hide();" text="关闭"
									icon="close.png" />
				</aos:docked>
			</aos:window>


			<aos:window id="_w_renewal" title="续借">
				<aos:formpanel id="_g_renewal" width="500" layout="anchor"
							   onrender="renewal_math_show" labelWidth="90">
					<aos:hiddenfield name="id_" />
					<aos:textfield name="borrow_card" fieldLabel="借阅单号" readOnly="true" columnWidth="0.49"/>
					<aos:textfield name="login_card" fieldLabel="登录号" readOnly="true" columnWidth="0.49"/>
					<aos:fieldset title="基本信息" labelWidth="70" columnWidth="1">
						<aos:textfield name="borrow_purpose" fieldLabel="借阅目的"
									   columnWidth="0.49" id="borrow_purpose"/>
						<aos:textfield name="renew_borrow_day" fieldLabel="续借天数" id="renew_borrow_day"
									   columnWidth="0.49"  onblur="get_expire_date" allowBlank="false"/>
						<aos:checkboxgroup id="borrow_type3_" disabled="true" fieldLabel="利用方式" columns="[120,120,120]" columnWidth="0.99" >
							<aos:checkbox name="c1" boxLabel="浏览"/>
							<aos:checkbox name="c1" boxLabel="下载" />
							<aos:checkbox name="c1" boxLabel="打印" />
						</aos:checkboxgroup>
						...
						<aos:textfield name="checked_person" id="checked_person" fieldLabel="审核人"
									   columnWidth="1" readOnly="true" value="管理员"/>
						<aos:textfield name="borrow_person" id="borrow_person2"
									   fieldLabel="借阅申请人" readOnly="true" columnWidth="0.33" />
						<aos:textfield name="borrow_date" id="borrow_date2"
									   fieldLabel="申请日期" readOnly="true" columnWidth="0.33" />
						<aos:hiddenfield name="expire_date" id="expire_date2" />
						<aos:textfield name="borrow_ip" id="borrow_ip2"
									   fieldLabel="申请机器"   readOnly="true" columnWidth="0.33" />
					</aos:fieldset>
				</aos:formpanel>
				<aos:docked dock="bottom" ui="footer">
					<aos:dockeditem xtype="tbfill" />
					<aos:dockeditem onclick="_w_save_renewal" text="保存" icon="close.png" />
					<aos:dockeditem onclick="#_w_renewal.hide();" text="关闭"
									icon="close.png" />
				</aos:docked>
			</aos:window>
