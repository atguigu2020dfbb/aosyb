...
<aos:html>
	<aos:head title="接收库管理">
		<aos:include lib="ext,swfupload" />
		<aos:base href="archive/data_manager" />
		<style>
	...
	<aos:onready>
		<aos:viewport layout="border">
			<aos:gridpanel id="_g_data" url="listAccounts.jhtml" region="center" split="true"
				...
				<!--  -->
				<aos:column header="操作" width="60" align="center" type="action">
					<aos:action handler="fn_button_render" icon="edit.png" tooltip="指导意见" />
				</aos:column>
