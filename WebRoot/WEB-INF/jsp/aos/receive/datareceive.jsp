...
<aos:onready>
	<aos:viewport layout="border">
		<aos:gridpanel id="_g_data" url="listAccounts.jhtml" region="center" split="true"
			onrender="_g_data_query" rowclass="true" pageSize="${pagesize }"
			 enableLocking="false" >
			<aos:docked>
				...
				<aos:dockeditem text="转管理库" icon="more/debug-step-over.png" onclick="manage_rollout_show"   id="_f_debug_step_over"/>
	...
	function _w_print_load(){
		...
		function manage_rollout_show(){
			var querySession=Ext.getCmp("querySession").getValue();
			var tablename=Ext.getCmp("tablename").getValue();
			var treenumber=Ext.getCmp("treenumber").getValue();
			AOS.ajax({
				params:{treenumber:treenumber,tablename:tablename,querySession:querySession},
