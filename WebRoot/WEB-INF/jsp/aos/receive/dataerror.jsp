...
<aos:html>
	...
	<aos:onready>
		<aos:viewport layout="border" id="viewport">
			<aos:gridpanel id="_g_data" url="listAccounts_error.jhtml" height="450" region="center" split="true"
			...
			<aos:window id="_w_data_i" title="新增" layout="fit"
						autoScroll="true"  y="100" width="800" height="500"
