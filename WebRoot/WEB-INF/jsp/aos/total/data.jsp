...
<aos:onready>
	<aos:viewport layout="border">
		<aos:gridpanel id="_g_data" url="listAccounts.jhtml" region="center" split="true"
			onrender="_g_data_query" pageSize="${pagesize }" rowclass="true" onitemclick="itemclick"
					   enableLocking="false" >
			<aos:docked>
				...
				<aos:dockeditem text="管理库转入" icon="more/debug-step-into.png" onclick="manage_shift_show"   id="_f_debug_step_into1"/>
				<aos:dockeditem text="档案总库转出" icon="more/debug-step-over.png" onclick="total_rollout_show"   id="_f_debug_step_over1"/>
				...
				<aos:dockeditem text="转资源管理库" icon="more/object-order-back.png"
								onclick="_w_totalTodata_show" />
				<aos:dockeditem text="打印" icon="icon146.png" onclick="#_w_print.show()" />
				<aos:dockeditem text="转入审核" icon="folder8.png" id="_shift_examine_show1"
								onclick="_shift_examine_show" />
				<aos:dockeditem text="转出审核" icon="folder8.png" id="rollout_examine_show1"
								onclick="rollout_examine_show" />
	...
	<aos:window id="_w_data_i" title="新增" width="1000" height="600" layout="fit"
		autoScroll="true"  y="100" onrender="_w_data_i_render">
		<aos:formpanel id="_f_data_i" labelWidth="100" autoScroll="true"  width="780" margin="0 0 0 20">
		</aos:formpanel>
	...
	<aos:window id="_w_task_list" title="任务列表" autoScroll="true" height="500" width="800" onshow="_w_task_list_show">
		<aos:gridpanel id="_g_task_list" region="east" url="listtaskshift.jhtml" height="400"
					   pageSize="10"   width="1500" autoScroll="true">
			<aos:docked>
				<aos:dockeditem xtype="tbtext" text="列表" />
				<aos:dockeditem onclick="create_task_show" text="新建任务" icon="ok.png" />
				<aos:dockeditem onclick="archive_delete_task" text="删除" icon="del.png" />
				<aos:dockeditem onclick="receive_add_total" text="加入总库" icon="folder8.png"/>
				<aos:dockeditem onclick="archive_message" text="档案详情" icon="query.png" />
				<aos:dockeditem onclick="submit_apply" text="提交申请" icon="more/archive-extract-3.png" />
			</aos:docked>
			<aos:column type="rowno" />
			<aos:column header="流水号" dataIndex="id_" hidden="true" />
			<aos:column header="任务名称" dataIndex="task_name"  width="200" align="true"/>
			<aos:column header="批次号" dataIndex="pch"  width="200" align="true"/>
			<aos:column header="提交人" dataIndex="tjr"  width="100" align="true"/>
			<aos:column header="提交时间" dataIndex="tjsj" width="200" align="true" />
			<aos:column header="提交描述" dataIndex="tjms" width="200" align="true" />
			<aos:column header="审核人" dataIndex="shrr"  width="100" align="true"/>
			<aos:column header="审核时间" dataIndex="shsj" width="200" align="true" />
			<aos:column header="审核描述" dataIndex="shms" width="200" align="true" />
			<aos:column header="入库状态" dataIndex="rkzt" width="100" align="true" />
			<aos:column header="部门名称" dataIndex="bmmc"  width="100" align="true" />
			<aos:column header="部门编号" dataIndex="bmbh"  width="100" align="true" />
			<aos:column header="提交状态" dataIndex="flag_submit"  width="100" align="true" />
			<aos:column header="审核状态" dataIndex="flag_examine"  width="100" align="true" />
		</aos:gridpanel>
		<aos:docked dock="bottom" ui="footer">
			<aos:dockeditem xtype="tbfill" />
			<aos:dockeditem onclick="#_w_task_list.close();" text="关闭" icon="close.png" />
		</aos:docked>
	</aos:window>
	<aos:window id="_w_task_list_out" title="任务列表" autoScroll="true" height="500" width="800" onshow="_w_task_list_out_show">
		<aos:gridpanel id="_g_task_list_out" region="east" url="listtaskshiftout.jhtml" height="400"
					   pageSize="10" split="true" splitterBorder="0 1 0 1" width="1500" autoScroll="true">
			<aos:docked>
				<aos:dockeditem xtype="tbtext" text="列表" />
				<aos:dockeditem onclick="create_task_out_show" text="新建任务" icon="ok.png" />
				<aos:dockeditem onclick="archive_delete_task_out" text="删除" icon="del.png" />
				<aos:dockeditem onclick="receive_add_out_total" text="导出数据" icon="folder8.png"/>
				<aos:dockeditem onclick="archive_out_message" text="档案详情" icon="query.png" />
				<aos:dockeditem onclick="submit_out_apply" text="提交申请" icon="more/archive-extract-3.png" />
			</aos:docked>
			<aos:column type="rowno" />
			<aos:column header="流水号" dataIndex="id_" hidden="true" />
			<aos:column header="任务名称" dataIndex="task_name"  width="200" align="true"/>
			<aos:column header="批次号" dataIndex="pch"  width="200" align="true"/>
			<aos:column header="提交人" dataIndex="tjr"  width="100" align="true"/>
			<aos:column header="提交时间" dataIndex="tjsj" width="100" align="true" />
			<aos:column header="提交描述" dataIndex="tjms" width="200" align="true" />
			<aos:column header="审核人" dataIndex="shrr"  width="100" align="true"/>
			<aos:column header="审核时间" dataIndex="shsj" width="200" align="true" />
			<aos:column header="审核描述" dataIndex="shms" width="200" align="true" />
			<aos:column header="导出状态" dataIndex="dczt" width="100" align="true" />
			<aos:column header="部门名称" dataIndex="bmmc"  width="100" align="true" />
			<aos:column header="部门编号" dataIndex="bmbh"  width="100" align="true" />
			<aos:column header="提交状态" dataIndex="flag_submit"  width="100" align="true" />
			<aos:column header="审核状态" dataIndex="flag_examine"  width="100" align="true" />
	...
	<aos:window id="_w_task_submit" title="任务列表" autoScroll="true" height="500" width="800" onshow="_w_task_submit_show">
		<aos:gridpanel id="_g_task_submit" region="east" url="listtaskshift.jhtml" pageSize="10" height="400"
					    split="true" splitterBorder="0 1 0 1" width="1500" autoScroll="true">
			<aos:docked>
				<aos:dockeditem xtype="tbtext" text="列表" />
				<aos:dockeditem onclick="archive_submit_message" text="档案详情" icon="query.png" />
				<aos:dockeditem onclick="archive_delete_message" text="删除" icon="del.png" />
				<aos:dockeditem onclick="lead_apply" text="领导审核" icon="more/archive-extract-3.png" />
			</aos:docked>
			<aos:column type="rowno" />
			<aos:column header="流水号" dataIndex="id_" hidden="true" />
			<aos:column header="任务名称" dataIndex="task_name"  width="200" align="true"/>
	...
	<aos:window id="_w_task_submit_out" title="任务列表" autoScroll="true" height="500" width="800" onshow="_w_task_submit_out_show">
		<aos:gridpanel id="_g_task_submit_out" region="east" url="listtaskshiftout.jhtml" height="400"
					   pageSize="10" split="true" splitterBorder="0 1 0 1" width="1500" autoScroll="true">
			<aos:docked>
				<aos:dockeditem xtype="tbtext" text="列表" />
				<aos:dockeditem onclick="archive_submit_out_message" text="档案详情" icon="query.png" />
				<aos:dockeditem onclick="archive_delete_out_message" text="删除" icon="del.png" />
				<aos:dockeditem onclick="lead_out_apply" text="领导审核" icon="more/archive-extract-3.png" />
			</aos:docked>
			<aos:column type="rowno" />
			<aos:column header="流水号" dataIndex="id_" hidden="true" />
			<aos:column header="任务名称" dataIndex="task_name"  width="200" align="true"/>
		...
		<aos:docked dock="bottom" ui="footer">
			<aos:dockeditem xtype="tbfill" />
			<aos:dockeditem onclick="#_w_task_submit_out.close();" text="关闭" icon="close.png" />
		</aos:docked>
	</aos:window>
	<aos:window id="_w_create_task" title="新增任务" >
		<aos:formpanel id="_f_create_task" width="500" layout="anchor" labelWidth="120">
			<aos:hiddenfield name="id_"  />
			<aos:textfield name="task_name" fieldLabel="任务名称" allowBlank="false" />
			<aos:combobox name="pch" fieldLabel="批次号" allowBlank="false" id="pch_on"
						  columnWidth="1.0" fields="['pch','pch_cn']" displayField="pch"
						  valueField="pch" onchang="load_qzh_on"
						  url="queryPchs.jhtml?tablename=${tablename}">
			</aos:combobox>
			<aos:textfield name="qzmc" fieldLabel="全宗名称"  />
			<aos:textfield name="qzh" fieldLabel="全宗编号" />
			<aos:textfield name="tjr" fieldLabel="提交人" />
			<aos:datefield name="tjsj" fieldLabel="提交时间" format="Y-m-d"
						   columnWidth="1.0" allowBlank="false"  />
			<aos:textareafield name="tjms" fieldLabel="提交描述"  />
		</aos:formpanel>
		<aos:docked dock="bottom" ui="footer">
			<aos:dockeditem xtype="tbfill" />
			<aos:dockeditem onclick="_w_create_task_submit" text="确定" icon="ok.png" />
			<aos:dockeditem onclick="#_w_create_task.hide();" text="关闭" icon="close.png" />
		</aos:docked>
	</aos:window>
	<aos:window id="_w_create_task_out" title="新增任务" >
		<aos:formpanel id="_f_create_task_out" width="500" layout="anchor" labelWidth="120">
			<aos:hiddenfield name="id_"  />
			<aos:textfield name="task_name" fieldLabel="任务名称" allowBlank="false" />
			<aos:combobox name="pch" id="pch_up"  fieldLabel="批次号" allowBlank="false"
						  columnWidth="1.0" fields="['pch','pch_cn']" displayField="pch"
						  valueField="pch" onchang="load_qzh_up"
						  url="queryPchs.jhtml?tablename=${tablename}">
			</aos:combobox>
			<aos:textfield name="qzmc" fieldLabel="全宗名称"  />
			<aos:textfield name="qzh" fieldLabel="全宗号" />
			<aos:textfield name="tjr" fieldLabel="提交人" />
			<aos:datefield name="tjsj" fieldLabel="提交时间" format="Y-m-d"
						   columnWidth="1.0" allowBlank="false"  />
			<aos:textareafield name="tjms" fieldLabel="提交描述"  />
		...
		<aos:docked dock="bottom" ui="footer">
			<aos:dockeditem xtype="tbfill" />
			<aos:dockeditem onclick="_w_create_task_submit_out" text="确定" icon="ok.png" />
			<aos:dockeditem onclick="#_w_create_task_out.hide();" text="关闭" icon="close.png" />
		</aos:docked>
	</aos:window>
	...
	<aos:window id="_w_next_kf_message_out" title="审核意见" width="500" >
		<aos:formpanel  id="_f_next_kf_message_out" width="480">
			<aos:textareafield fieldLabel="意见说明" id="next_kf_message_out"  name="next_kf_message_out" width="450" allowBlank="false"/>
		</aos:formpanel>
		<aos:docked dock="bottom" ui="footer">
			<aos:dockeditem xtype="tbfill" />
			<aos:dockeditem text="通过" onclick="_save_next_kf_message_out" icon="agree.png" />
			<aos:dockeditem text="未通过" onclick="no_save_next_kf_message_out" icon="against.png" />
			<aos:dockeditem onclick="#_w_next_kf_message_out.hide();" text="关闭"
							icon="close.png" />
		</aos:docked>
	</aos:window>
	...
	<aos:window id="_w_print" title="打印列表" height="400" width="300"
		...
		<aos:gridpanel id="_g_print" region="center"
					   ...
					   hidePagebar="true"
					   splitterBorder="0 1 0 1" width="280" height="380">
			<aos:selmodel type="row" mode="multi" />
	...
	<script type="text/javascript">
		...
		window.onload=function() {
			...
			if (compilation_flag === "数字科员") {
				Ext.getCmp("_shift_examine_show1").hide();
				Ext.getCmp("rollout_examine_show1").hide();
			} else if (compilation_flag === "数字管理员") {
				Ext.getCmp("_f_debug_step_into1").hide();
				Ext.getCmp("_f_debug_step_over1").hide();
			}
		}
        Ext.getCmp("_shift_examine_show1").hide();
        Ext.getCmp("rollout_examine_show1").hide();
		...
		function print_report(){
			...
			AOS.ajax({
				params:{
					...
					_classtree:Ext.getCmp("_classtree" +
							"").getValue(),
            ...
            var uploadPanel= new Ext.ux.uploadPanel.UploadPanel({
                ...
                listeners:{
                    ...
                    itemdblclick : function(grid,row,kk,rowIndex){
                        ...
                        parent.fnaddtab(row.data.id, '电子文件',
                            'archive/data/openPdfFile.jhtml?id='+row.data.pid+'&tid='+row.data.tid+'&type='+row.data.type+'&tablename='+tablename.getValue()+'&dh='+record.data.dh);
                        /*parent.fnaddtab(row.data.id, '电子文件',
                                'archive/data/openFile.jhtml?id='+row.data.pid+'&tid='+row.data.tid+'&type='+row.data.type+'&tablename='+tablename.getValue()+'&index='+rowIndex);*/
                        /*parent.fnaddtab(row.data.id, '电子文件',
                                             'archive/data1/initZpData.jhtml?id='+row.data.pid+'&tid='+row.data.tid+'&type='+row.data.type+'&tablename='+tablename.getValue());*/
	...
	//转入管理库
	function _w_totalTodata_show(){
		var query=Ext.getCmp("querySession").getValue();
		AOS.ajax({
			url : 'totalTodata.jhtml',
			params:{
				query:query,
				tablename : tablename.getValue()
			},
	...
	function _w_print_load(){
		...
		function manage_shift_show(){
			_w_task_list.show();
		}

		function total_rollout_show(){
			_w_task_list_out.show();

		}
		function _shift_examine_show(){
			_w_task_submit.show();
		}
		function rollout_examine_show(){
			_w_task_submit_out.show();
		}
		function create_task_show(){

			_w_create_task.show();
		}
		function create_task_out_show(){

			_w_create_task_out.show();
		}
		function _w_create_task_submit(){
			AOS.ajax({
				forms : _f_create_task,
				url : 'createTask.jhtml',
				params:{
					tablename : tablename.getValue()
				},
				ok : function(data) {
					AOS.tip(data.appmsg);
					_w_create_task.hide();
					_g_task_list_store.reload();
				}
			});
		}
		function _w_create_task_submit_out(){
			AOS.ajax({
				forms : _f_create_task_out,
				url : 'createTaskout.jhtml',
				params:{
					tablename : tablename.getValue()
				},
				ok : function(data) {
					AOS.tip(data.appmsg);
					_w_create_task_out.hide();
					_g_task_list_out_store.reload();
				}
			});
		}
		//获取任务列表
		function _w_task_list_show(){
		//当前数据表的批次号任务数据列表
			var params = {
				tablename : tablename.getValue()
			};
			//这个Store的命名规则为：表格ID+"_store"。
			_g_task_list_store.getProxy().extraParams = params;
			_g_task_list_store.load();
		}
		function _w_task_list_out_show(){
			var params = {
				tablename : tablename.getValue()
			};
			//这个Store的命名规则为：表格ID+"_store"。
			_g_task_list_out_store.getProxy().extraParams = params;
			_g_task_list_out_store.load();
		}
		//档案详情
		function archive_message(){
				var selection = AOS.selection(_g_task_list, 'id_');
				if (AOS.empty(selection)) {
					AOS.tip('查看详情前请先选中任务。');
					return;
				}
				var pch=AOS.selectone(_g_task_list).raw.pch;
				var tablename=AOS.selectone(_g_task_list).raw.tablename;
				window.parent.fnaddtab('','档案详情','/archive/datatotal/archive_details.jhtml?pch='+pch+'&tablename='+tablename);
		}
		//档案详情
		function archive_submit_message(){
			var selection = AOS.selection(_g_task_submit, 'id_');
			if (AOS.empty(selection)) {
				AOS.tip('查看详情前请先选中任务。');
				return;
			}
			var pch=AOS.selectone(_g_task_submit).raw.pch;
			var tablename=AOS.selectone(_g_task_submit).raw.tablename;
			window.parent.fnaddtab('','档案详情','/archive/datatotal/archive_details.jhtml?pch='+pch+'&tablename='+tablename);
		}
		//档案导入领导审核(任务删除)
		function archive_delete_message(){
			var selection = AOS.selection(_g_task_submit, 'id_');
			if (AOS.empty(selection)) {
				AOS.tip('删除前请先选中任务。');
				return;
			...
			AOS.ajax({
				params:{aos_rows_:selection},
				url : 'deleteTotal_In_examine_Rw.jhtml',
				ok : function(data) {
					AOS.tip(data.appmsg);
					_g_task_submit_store.reload();
				}
			});
		}

		//档案导出领导审核(任务删除)
		function archive_delete_out_message(){
			var selection = AOS.selection(_g_task_submit_out, 'id_');
			if (AOS.empty(selection)) {
				AOS.tip('删除前请先选中任务。');
				return;
			}
			AOS.ajax({
				params:{aos_rows_:selection},
				url : 'deleteTotal_Out_examine_Rw.jhtml',
				ok : function(data) {
					AOS.tip(data.appmsg);
					_g_task_submit_out_store.reload();
				}
			});
		}

		//档案导入用户提交(任务删除)
		function archive_delete_task(){
			var selection = AOS.selection(_g_task_list, 'id_');
			if (AOS.empty(selection)) {
				AOS.tip('删除前请先选中任务。');
				return;
			...
			AOS.ajax({
				params:{aos_rows_:selection},
				url : 'deleteTotal_In_submint_Rw.jhtml',
				ok : function(data) {
					AOS.tip(data.appmsg);
					_g_task_list_store.reload();
				}
		...
		//档案导出用户提交(任务删除)
		function archive_delete_task_out(){
			var selection = AOS.selection(_g_task_list_out, 'id_');
			if (AOS.empty(selection)) {
				AOS.tip('删除前请先选中任务。');
				return;
			}
			AOS.ajax({
				params:{aos_rows_:selection},
				url : 'deleteTotal_Out_submint_Rw.jhtml',
				ok : function(data) {
					AOS.tip(data.appmsg);
					_g_task_list_out_store.reload();
				}
		...
		//档案详情
		function archive_submit_out_message(){
			var selection = AOS.selection(_g_task_submit_out, 'id_');
			if (AOS.empty(selection)) {
				AOS.tip('查看详情前请先选中任务。');
				return;
			}
			var pch=AOS.selectone(_g_task_submit_out).raw.pch;
			var tablename=AOS.selectone(_g_task_submit_out).raw.tablename;
			window.parent.fnaddtab('','档案详情','/archive/datatotal/archive_details.jhtml?pch='+pch+'&tablename='+tablename);
		}
		//档案详情
		function archive_out_message(){
			var selection = AOS.selection(_g_task_list_out, 'id_');
			if (AOS.empty(selection)) {
				AOS.tip('查看详情前请先选中任务。');
				return;
			}
			var pch=AOS.selectone(_g_task_list_out).raw.pch;
			var tablename=AOS.selectone(_g_task_list_out).raw.tablename;
			window.parent.fnaddtab('','档案详情','/archive/datatotal/archive_details.jhtml?pch='+pch+'&tablename='+tablename);
		}
		//提交申请
		function submit_apply(){
			...
			var id_="";
			var flag_submit="";
				id_=AOS.selectone(_g_task_list).raw.id_;
				flag_submit=AOS.selectone(_g_task_list).raw.flag_submit;
			if(flag_submit=="已提交"){
				AOS.tip('已提交无须重复提交!');
				return;
			}
			var msg = AOS.merge('确认要提交选中的任务数据吗？');
			AOS.confirm(msg, function (btn) {
				if (btn === 'cancel') {
					AOS.tip('提交操作被取消。');
					return;
				...
				AOS.ajax({
					params:{aos_module_id_:aos_module_id_,
						tablename:tablename,
		...
		function submit_out_apply(){
			...
			var id_="";
			var flag_submit="";
			id_=AOS.selectone(_g_task_list_out).raw.id_;
			flag_submit=AOS.selectone(_g_task_list_out).raw.flag_submit;
			if(flag_submit=="已提交"){
				AOS.tip('已提交无须重复提交!');
				return;
			}
		...
		function lead_apply(){
			...
			var record = AOS.selectone(_g_task_submit);
			var flag_submit="";
			var flag_examine="";
			if(!AOS.empty(record)){
		...
		function lead_out_apply(){
			var selection = AOS.selection(_g_task_submit_out, 'id_');
			if (AOS.empty(selection)) {
				AOS.tip('提交前请先选中数据!');
				return;
			}
			var record = AOS.selectone(_g_task_submit_out);
			var flag_submit="";
			var flag_examine="";
			if(!AOS.empty(record)){
				flag_submit=record.data.flag_submit;
		...
		function _save_next_kf_message_out(){
			var record = AOS.selectone(_g_task_submit_out);
			var id_="";
			if(!AOS.empty(record)){
				id_=record.data.id_;
			...
			var aos_module_id_=Ext.getCmp("aos_module_id_").getValue();
			AOS.ajax({
				forms : _f_next_kf_message_out,
				params:{aos_module_id_:aos_module_id_,
					tablename:tablename,
					cascode_id_:_classtree_f,
					'id_':id_},
				url : 'updatetotalyes.jhtml',
				ok : function(data) {
					_w_next_kf_message_out.hide();
					AOS.tip(data.appmsg);
					_g_task_submit_out_store.reload();
		...
		//根据批次号加载部门名称和部门编号
		function load_qzh_on(){
			var pch=Ext.getCmp("pch_on").getValue();
			//
			AOS.ajax({
				params:{pch:pch},
				url : 'getQzh.jhtml',
				ok : function(data) {
					...
					_f_create_task.getForm().findField('qzh').setValue(data.qzh);
					_f_create_task.getForm().findField('qzmc').setValue(data.qzmc);
				}
			});
		}
		function load_qzh_up(){
			var pch=Ext.getCmp("pch_up").getValue();
			//
			AOS.ajax({
				params:{pch:pch},
				url : 'getQzh.jhtml',
				ok : function(data) {
					...
					_f_create_task_out.getForm().findField('qzh').setValue(data.qzh);
					_f_create_task_out.getForm().findField('qzmc').setValue(data.qzmc);
				}
			});
		}
		function no_save_next_kf_message_out(){
			var record = AOS.selectone(_g_task_submit_out);
			var id_="";
			if(!AOS.empty(record)){
				id_=record.data.id_;
		...
		function _w_task_submit_show(){
			var params = {
				tablename : tablename.getValue()
			};
			//这个Store的命名规则为：表格ID+"_store"。
			_g_task_submit_store.getProxy().extraParams = params;
			_g_task_submit_store.load();
		}
		function _w_task_submit_out_show(){
			var params = {
				tablename : tablename.getValue()
			};
			//这个Store的命名规则为：表格ID+"_store"。
			_g_task_submit_out_store.getProxy().extraParams = params;
			_g_task_submit_out_store.load();
		}
		function receive_add_total(){
			var selection = AOS.selection(_g_task_list, 'id_');
			if (AOS.empty(selection)) {
				AOS.tip('提交前请先选中数据!');
				return;
			}
			var record = AOS.selectone(_g_task_list);
			var flag_submit="";
			var flag_examine="";
			if(!AOS.empty(record)){
				flag_submit=record.data.flag_submit;
				...
				if(flag_submit=="已提交"&&flag_examine=="已通过"){
					...
					var pch="";
					var tablename=Ext.getCmp("tablename").getValue();
					var treenumber=record.data.bmbh;
					if(!AOS.empty(record)){
						id_=record.data.id_;
						pch=record.data.pch;
					}
					AOS.ajax({
						params:{id_:id_,tablename:tablename,treenumber:treenumber,pch:pch},
						url : 'receiveTototalData.jhtml',
						ok : function(data) {
							AOS.tip(data.appmsg);
							_g_task_list_store.reload();
							_g_data_store.reload();
					...
					AOS.tip('未提交或提交后未通过不能正式入库!');
					return;
				}

		}
		function receive_add_out_total(){
			var selection = AOS.selection(_g_task_list_out, 'id_');
			if (AOS.empty(selection)) {
				AOS.tip('提交前请先选中数据!');
				return;
			}
			var record = AOS.selectone(_g_task_list_out);
			var flag_submit="";
			var flag_examine="";
			var pch="";
			if(!AOS.empty(record)){
			...
			if(flag_submit=="已提交"&&flag_examine=="已通过"){
				...
				AOS.ajax({
					params:{id_:id_,tablename:tablename,pch:pch},
					url : 'totalTooutData.jhtml',
					ok : function(data) {
						AOS.tip(data.appmsg);
						AOS.file('${cxt}/report/xls.jhtml');
						_g_task_list_out_store.reload();
				...
				AOS.tip('未提交或提交后未通过不能导出!');
				return;
			}
		}
		function printGrid() {
		var cnslist="<%=request.getAttribute("cns")%>";
			var enslist="<%=request.getAttribute("ens")%>";
		   var cnsstr=cnslist.substring(1,cnslist.length-1);
			var ensstr=enslist.substring(1,enslist.length-1);
			var gridcontrol = Ext.getCmp('_g_data');
			var tableStr = '<table  border="1" style="width:100%" cellpadding="0" cellspacing="0">';
			//添加第一行列名行
			for(var j=0;j<cnsstr.split(',').length;j++){
				if(j==0){
					tableStr+='<tr><td>'+cnsstr.split(',')[j]+'</td>'
				}else if(j==cnsstr.split(',').length-1){
					tableStr+='<td>'+cnsstr.split(',')[j]+'</td></tr>'
				}else{
					tableStr+='<td>'+cnsstr.split(',')[j]+'</td>'
				}
			}
			...
			if(count>0){
				for(var i=0;i<count;i++){
					for(var j=0;j<ensstr.split(',').length;j++){
						var text=_g_data_store.getAt(i).get(ensstr.split(',')[j]);
						if (typeof(text) == "undefined")
						{
							text="";
						}
						if(j==0){
							tableStr+='<tr><td>'+text+'</td>'
						}else if(j==ensstr.length-1){
							tableStr+='<td>'+text+'</td></tr>'
						}else{
							tableStr+='<td>'+text+'</td>'
						}
					}
