...
%>
<aos:html>
	<aos:head title="利用人次、件次统计">
		<aos:include lib="ext" />
		<aos:base href="count/statistics_personjianci" />
		<style>
			._div_tips table tr {
				align:"true"
			}
	...
	<aos:onready>
		<aos:viewport layout="border" id="viewport"  autoScroll="true" split="true">
					...
					<aos:formpanel id="_f_info" layout="column" region="center" labelWidth="70" height="200"
						...
						<aos:datefield name="shijian" id="shijian" margin="50 0 0 0" fieldLabel="时间" format="Y-m-d" editable="false" columnWidth="0.24" allowBlank="false" />
			...
			function tj1_load(){
				...
				AOS.ajax({
					...
					ok : function(data) {
						...
						tab+='<caption style="font-size: 30px" >档案利用人次、件次统计表</caption>';
						tab+='<tr style="font-size:15px;text-align: center;">\n' +
								'\t\t\t\t\t<th tyle="text-align: center;" rowspan="1" >时间</th>\n' +
								'\t\t\t\t\t<th tyle="text-align: center;" rowspan="1">人次</th>\n' +
								'\t\t\t\t\t<th tyle="text-align: center;" colspan="1">件次</th>\n' +
								'\t\t\t\t</tr>';
						var obj=eval(data);
						for (var x in obj) {
							tab+='<tr style="font-size:15px;text-align: center;">\n' +
									'\t\t\t\t\t<td tyle="text-align: center;">'+obj[x].shijian+'</td>\n' +
									'\t\t\t\t\t<td tyle="text-align: center;">'+obj[x].rc+'</td>\n' +
									'\t\t\t\t\t<td tyle="text-align: center;">'+obj[x].jc+'</td>\n' +
									'\t\t\t\t</tr>';
						}
						tab+='</table>';
