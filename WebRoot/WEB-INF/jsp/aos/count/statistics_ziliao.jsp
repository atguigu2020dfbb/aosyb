...
%>
<aos:html>
	<aos:head title="档案资料库统计">
		<aos:include lib="ext" />
		<aos:base href="count/statistics_ziliao" />
		<style>
			._div_tips table tr {
				align:"true"
			}
	...
	<aos:onready>
		<aos:viewport layout="border" id="viewport"  autoScroll="true" split="true">
					...
					<aos:formpanel id="_f_info" layout="column" region="center" labelWidth="70" height="200"
						...
						<aos:combobox  name="qzh" id="qzh" fieldLabel="全宗号（用于测试表现）" margin="50 0 0 0" dicField="qzh"  columnWidth="0.24" />
		...
		<script type="text/javascript">
			...
			function tj1_load(){
				...
				AOS.ajax({
					...
					qzdesc:Ext.getCmp("qzh").getRawValue()},
					url : 'countMath.jhtml',
					ok : function(data) {
						//添加table的名称   已经列名
