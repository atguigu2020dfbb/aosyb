...
%>
<aos:html>
	<aos:head title="档案临时库统计">
		<aos:include lib="ext" />
		<aos:base href="count/statistics_temporary" />
		<style>
			._div_tips table tr {
				align:"true"
			}
	...
	<aos:onready>
		<aos:viewport layout="border" id="viewport"  autoScroll="true" split="true">
					...
					<aos:formpanel id="_f_info" layout="column" region="center" labelWidth="70" height="200"
						...
						<aos:combobox name="nd" fieldLabel="年度" margin="50 0 0 0"  id="nd" value="2000" columnWidth="0.24" allowBlank="false">
