...
<aos:html>
	<aos:head title="图形显示">
		<aos:include lib="ext" />
		<aos:base href="depot/graph" />
		<style>
			body{ text-align:center}
		</style>
	</aos:head>
	<aos:body >
		<div id="_div_tips" style="text-align: center;width: 900px;height: 500px;margin-left: 100px;margin-top: 50px;" >
		</div>
	</aos:body>
	<aos:onready>
			...
			<aos:panel region="center" border="false">
				...
				<aos:panel height="200" layout="fit" autoScroll="true">
					<aos:formpanel id="_f_info" layout="column" labelWidth="70"
						...
						<aos:combobox name="archive_storehouse" fieldLabel="库房名称" id="archive_storehouse" value="X1" columnWidth="0.24" allowBlank="false">
				...
				<aos:panel layout="fit" id="nd_tjt" >
					<aos:docked forceBoder="1 0 1 0">
						<aos:dockeditem xtype="tbtext" text="存址图形列表" />
					</aos:docked>
				</aos:panel>
				<!--添加对应的table表格-->
			...
			function location_register(){
				...
				AOS.ajax({
					params:{archive_storehouse:archive_storehouse,
						archive_storehouse_raw:archive_storehouse_raw,
						column_number:column_number,
						group_number:group_number},
					url:'getlocation.jhtml',
					ok:function(data){
						//设计一个随机数编号
						var table='<table border="1" id="location_table" style="text-align:center;margin-top: 50px;margin-left: 50px" cellspacing="0" width="800px"  >';
						table+='<caption style="font-size: 30px" >'+archive_storehouse_raw+'档案存放位置索引标示图</caption>';
						table+='<tr style="font-size:15px;text-aligh:center"><td style="text-align: center" rowspan="3"  width="50px">组号</td>' +
								'<td style="text-align: center"  width="25px">列号</td><td style="text-align: center" colspan="8" id="liehao_number">'+column_number+'</td></tr>';
						table+='<tr style="font-size:15px;text-aligh:center"><td style="text-align: center"  width="25px">AB面</td>' +
								'<td  style="text-align: center" colspan="4" >A</td><td  style="text-align: center" colspan="4">B</td></tr>';
						table+='<tr style="font-size:15px;text-aligh:center"><td style="text-align: center" width="25px" height="50px">节号隔号</td>' +
								'<td  style="text-align: center" width="50px">1</td><td  style="text-align: center" width="50px">2</td>' +
								'<td  style="text-align: center" width="50px">3</td><td  style="text-align: center" width="50px">4</td>' +
								'<td  style="text-align: center" width="50px">1</td><td  style="text-align: center" width="50px">2</td>' +
								'<td  style="text-align: center" width="50px">3</td><td  style="text-align: center" width="50px">4</td></tr>';

						for(var i=1;i<=6;i++){
							if(i===1){
								table += '<tr style="font-size:15px;text-aligh:center"><td style="text-align: center" rowspan="6"  id="zuhao_number">' + group_number + '</td>';
								table += '<td style="text-align: center" width="50px">'+i+'</td>';
							}else{
								table += '<tr style="font-size:15px;text-aligh:center">';
								table += '<td style="text-align: center" width="50px">'+i+'</td>';
							}
							for(var j=1;j<=8;j++){
								table +='<td  style="text-align: center" width="100px">'+data[i*8-(8-j)-1].cz_name+'</td>';
							}
							table +='</tr>';
						}
						table+='</table>';
